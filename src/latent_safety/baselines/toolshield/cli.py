...
from latent_safety.baselines.toolshield._paths import default_agent_config, default_eval_dir, repo_root
...
def generate(args: argparse.Namespace) -> None:
    from latent_safety.baselines.toolshield import tree_generation
    from latent_safety.baselines.toolshield.inspector import inspect_mcp_tools
...
def auto_discover(args: argparse.Namespace) -> None:
    ...
    from latent_safety.baselines.toolshield.mcp_scan import main as scan_main
