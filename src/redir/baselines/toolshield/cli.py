...
from redir.baselines.toolshield._paths import default_agent_config, default_eval_dir, repo_root
...
def generate(args: argparse.Namespace) -> None:
    from redir.baselines.toolshield import tree_generation
    from redir.baselines.toolshield.inspector import inspect_mcp_tools
...
def auto_discover(args: argparse.Namespace) -> None:
    ...
    from redir.baselines.toolshield.mcp_scan import main as scan_main
