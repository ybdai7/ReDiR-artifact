...
class MemGenLoraSwitchMixin:
    ...
    def _insert_lora_adapters(
        ...
        if trigger_model is None:
            trigger_model_with_lora = weaver_model_with_lora
        else:
    ...
    def fix_component(self, name: Literal["weaver", "trigger"]):
        ...
        if name == "trigger" and getattr(self, "weaver", None) is not None and component.model is self.weaver.model:
            fix_model_parameters(component.output_layer)
            return
